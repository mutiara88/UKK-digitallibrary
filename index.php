	...
	<div class="content mt-3">
		...
		<div class="content mt-3">
				<div class="row">
					<div class="col-sm-3">
					<div class="card">
						<div class="card-body bg-info text-center" style="--bs-bg-opacity: .5;">
							<h3>INPUT DATA BUKU</h3>
							<h2>^-^</h2>
							<hr>
						<a href = "buku.php" class ="btn btn-dark  d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">Lihat Data</a>
					</div>
				</div>
			</div>
			<div class="col-sm-3">
					<div class="card">
						<div class="card-body bg-info text-center" style="--bs-bg-opacity: .5;">
							...
							<h2>^0^</h2>
							<hr>
						<a href = "kategoribuku.php" class ="btn btn-dark  d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">Lihat Data</a>
					</div>
				</div>
			</div>
			<div class="col-sm-3">
					...
					<div class="card-body bg-info text-center" style="--bs-bg-opacity: .5;">
							...
							<h2>^-^</h2>
							<hr>
						<a href = "../admin/user/tampil_user.php" class ="btn btn-dark d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">Lihat Data</a>
					</div>
				</div>
			</div>
			<div class="col-sm-3">
					<div class="card">
						<div class="card-body bg-info text-center" style="--bs-bg-opacity: .5;">
							...
							<h2>^0^ </h2>
							<hr>
						<a href = "http://localhost/digitallibrary/peminjam/form_peminjaman.php/" class="btn btn-dark d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">Lihat Data</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="content mt-3"> 
			<p class="text-center">@2024 UKK Aplikasi Perpustakaan Digital By.Mutiara Cantika</p>
	</div>
